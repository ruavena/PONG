...
function love.load()
	...
	love.window.setTitle('GAME DEVELOPMENT LECTURE 0 "PONG"')
...
function love.draw()
	...
	love.graphics.setFont(smallFont)
    	...
    	if gameState == 'start' then
        	...
        	love.graphics.printf('Welcome to POGS Pong!', 0, VIRTUAL_HEIGHT / 2 - 16, VIRTUAL_WIDTH, 'center')
		love.graphics.setFont(smallFont)
        	love.graphics.printf('Press ENTER to begin!', 0, VIRTUAL_HEIGHT / 2 + 8, VIRTUAL_WIDTH, 'center')
	...
	elseif gameState == 'done' then
		...
		love.graphics.printf('Congratulation!', 0, 20, VIRTUAL_WIDTH, 'center')
        	love.graphics.setFont(smallFont)
